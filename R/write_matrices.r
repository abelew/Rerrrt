...
#' @param verbose Print!
#' @export
write_matrices <- function(retlist, excel, min_reads = NULL, min_indexes = NULL,
  ...
  indexes_written <- hpgltools::write_xlsx(wb = wb, data = retlist[["indexes_remaining"]],
                                           sheet = sheet,
  ...
  a_plot <- plot_index_density(data = retlist[["pre_chng_index_density_dt"]],
  ...
  message("Plotting ", title)
  a_plot <- plot_index_density(data = retlist[["pre_ident_index_density_dt"]],
                               metadata = retlist[["metadata"]], title = title)
  ...
  message("Plotting ", title)
  a_plot <- plot_index_density(data = retlist[["pre_index_density_dt"]],
                               metadata = retlist[["metadata"]], title = title)
  ...
  message("Plotting ", title)
  dt <- retlist[["post_chng_index_density_dt"]]
  a_plot <- plot_index_density(data = retlist[["post_chng_index_density_dt"]],
                               metadata = retlist[["metadata"]], title = title)
  ...
  message("Plotting ", title)
  a_plot <- plot_index_density(data = retlist[["post_ident_index_density_dt"]],
                               metadata = retlist[["metadata"]], title = title)
  ...
  message("Plotting ", title)
  a_plot <- plot_index_density(data = retlist[["post_index_density_dt"]],
                               metadata = retlist[["metadata"]], title = title)
  ...
  rt_table_order <- c("miss_indexes_by_refnt", "miss_indexes_by_hitnt", "miss_indexes_by_type",
